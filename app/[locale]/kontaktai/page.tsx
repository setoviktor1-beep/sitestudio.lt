...
export async function generateMetadata({
  ...
  return {
    title: `${dict.nav.cta} — SiteStudio`,
    description: dict.meta.description,
    alternates: { canonical: `/${locale}/kontaktai`, languages: pathAlternates("/kontaktai") },
  };
}

export default async function LocalizedKontaktaiPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const jsonLd = siteGraph(
    webPageNode(`/${locale}/kontaktai`, `${dict.nav.cta} — SiteStudio`, dict.meta.description, locale),
    breadcrumbNode(`/${locale}/kontaktai`, crumbs),
  );
  ...
  return (
    <div className="min-h-screen bg-white text-[#0f172a] antialiased">
      ...
      <main id="turinys" className="pt-28 md:pt-32">
        ...
        <Contact dict={dict} locale={locale as Locale} />
      </main>
